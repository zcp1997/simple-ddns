...
```bash
wget -O ddns-manualconf.sh https://raw.githubusercontent.com/zcp1997/simple-ddns/main/ddns-manualconf.sh && chmod +x ddns-manualconf.sh && bash ddns-manualconf.sh
```
